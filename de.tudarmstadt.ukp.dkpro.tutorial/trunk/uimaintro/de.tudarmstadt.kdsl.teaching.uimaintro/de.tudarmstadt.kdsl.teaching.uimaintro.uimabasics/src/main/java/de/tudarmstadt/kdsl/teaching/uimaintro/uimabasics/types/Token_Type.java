...
public class Token_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.tudarmstadt.kdsl.teaching.uimaintro.uimabasics.types.Token");
  ...
  public int getLength(int addr) {
      ...
      jcas.throwFeatMissing("length", "de.tudarmstadt.kdsl.teaching.uimaintro.uimabasics.types.Token");
